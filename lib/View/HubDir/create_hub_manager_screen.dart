            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: ColorConst.primaryGreen.withOpacity(0.07),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: ColorConst.primaryGreen.withOpacity(0.12),
              ...
              _buildCard(children: [
                _buildField(
                  ...
                  validator: (v) =>
                  (v == null || v.isEmpty) ? 'Hub name is required' : null,
                ),
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: _locationPicked
                          ? ColorConst.primaryGreen.withOpacity(0.07)
  ...
  Widget _readOnlyRow(IconData icon, String label, String value) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(10),
        border: Border.all(
            color: ColorConst.primaryGreen.withOpacity(0.15)),
      ),
      child: Row(
        children: [
