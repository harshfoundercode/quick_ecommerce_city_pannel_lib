...
//
//       // Circle (coverage radius)
//       _circles.add(
//         Circle(
//           circleId: CircleId('circle_${zone.id}'),
//           center: position,
//           radius: zone.radiusInKm * 1000, // metres
...
//     return (14 - math.log(radiusKm) / math.log(2)).clamp(8.0, 16.0);
//   }
//
...
//                   target: LatLng(26.8467, 80.9462), // Lucknow centre
//                   zoom: 11,
//                 ),
//                 markers: _markers,
//                 circles: _circles,
...
//                       offset: Offset(
//                           0, (1 - _bottomSheetAnimation.value) * 260),
//                       child: child,
//                     ),
...
//                     borderRadius: BorderRadius.circular(14),
//                   ),
//                   child: Icon(Icons.hub_rounded, color: zoneColor, size: 24),
//                 ),
...
class _HubZoneMapScreenState extends State<HubZoneMapScreen>
  ...
  double _cityZoneRadius(HubZoneListData zone) {
    try {
      final r = double.tryParse(zone.radiusInKm?.toString() ?? '');
      if (r != null && r > 0) return r;
    } catch (_) {}
    return double.infinity; // no boundary if unknown
  }
