...
//       final cityStockVM = Provider.of<CityStockViewModel>(context,listen: false);
//       cityStockVM.getCityStockDataApi(context);
...
//   }
//
//   int get _stock => _product?.totalStock ?? 0;
...
//       _product != null && _stock > 0 && _hubId != null && _qtyValid;
//
...
//         builder: (context, vm, hubVm, _) => Column(
//           children: [
//             Expanded(
//               child: ListView(
...
//               ),
//               child: Icon(
//                 p != null ? Icons.inventory_2_rounded : Icons.add_box_outlined,
//                 size: 18,
//                 color: p != null
...
//                               ),
//                             ),
//                             if (p.variant?.name != null &&
//                                 p.variant?.name != 'Default') ...[
...
//                   Expanded(
//                     child: Text(
//                       'This product is out of stock — cannot be transferred.',
...
//                 Text(
//                   received > 0
//                       ? '${((stock / received) * 100).toStringAsFixed(0)}%'
//                       : '—',
//                   style: TextStyle(
//                     fontSize: 10,
//                     fontWeight: FontWeight.w600,
...
//                   _hubId = v;
//                   _hubName = hubs
//                       .firstWhere((h) => h.hubId.toString() == v)
//                       .hubName;
//                 }),
//               ),
//             ),
...
//               children: [
//                 Text(
//                   'Transferring $_qty of $_stock units',
//                   style: const TextStyle(
//                     fontSize: 11,
//                     color: Color(0xFF6B7280),
//                   ),
...
//                   _qtyValid ? ColorConst.primaryGreen : Colors.red,
//                 ),
//                 minHeight: 6,
//               ),
//             ),
...
//             'Remaining',
//             '$remaining units',
//             color: remaining < 10 ? const Color(0xFFDC2626) : null,
//           ),
//         ],
//       ),
//     );
...
//         label: Text(
//           vm.transferLoading ? 'Transferring…' : 'Confirm Transfer',
//           style: const TextStyle(
//             fontSize: 15,
//             fontWeight: FontWeight.w700,
//             color: Colors.white,
...
//   // ── Helpers ────────────────────────────────────────────────────────────────
//
//   Widget _label(String t, IconData icon) => Row(
//     children: [
