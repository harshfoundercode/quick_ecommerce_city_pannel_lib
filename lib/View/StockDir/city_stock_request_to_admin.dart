...
//
//     final isLow = product != null && (product.totalStock ?? 0) < 10;
//     final isOut = product != null && (product.totalStock ?? 0) == 0;
//
...
//             final stockColor = (product.totalStock ?? 0) == 0
//                 ? const Color(0xFFEF4444)
...
//                           Row(
//                             children: [
//                               if (product.variants?.first.value != null &&
//                                   product.variants?.first.value != 'Default')
//                                 Text(
//                                   '${product.variants?.first.value} · ',
//                                   style: const TextStyle(
//                                     fontSize: 10,
//                                     color: Color(0xFF6B7280),
//                                   ),
...
//             _infoChip(Icons.category_outlined, product.mainCategoryName, const Color(0xFF6366F1)),
//           if (product.categoryName != null)
//             _infoChip(Icons.label_outline_rounded, product.mainCategoryName, const Color(0xFF0891B2)),
//           if (product.subcategoryName != null)
//             _infoChip(Icons.subdirectory_arrow_right_rounded, product.subcategoryName, const Color(0xFF059669)),
//           if (product.variants!.first.value != null && product.variants!.first.value != 'Default')
//             _infoChip(Icons.tune_rounded, product.variants!.first.value, const Color(0xFFF59E0B)),
//             // _infoChip(Icons.download_rounded, 'Received: ${product.totalReceived ?? "0"}', const Color(0xFF8B5CF6)),
//           if (product.variants?.first.value != null)
//             _infoChip(Icons.line_weight, 'Weight: ${product.variants?.first.value}', const Color(0xFF8B5CF6)),
//         ],
//       ),
//     );
//   }
