class ApiUrl {
  ...
  static const String baseurl = "https://root.fastocatz.com/";
  ...
  /// stock request to admin
  static String adminTransferHistoryUrl = "${configUrl1}admintransfer_history";

  /// admin ke beje hue incoming stock history check
  static String acceptTransferUrl = "${configUrl1}accept_transfer";

  /// admin ke beje hue incoming stock accept
